...
┗━━━━━━━━━━━━━━━┛  
╭━━━━━━━━━━━━━━━╮  
┃ **Register:** ${rtotalreg} de ${totalreg}  
╰━━━━━━━━━━━━━━━╯`
...
┊┃ *👑 OWNER MENU 👑*
┊┃━━━━━━━━━━━━━━•
┊┃ _(THIS COMMAND IS OWNER COMMANDS)_
┊┃━━━━━━━━━━━━━━•
...
┗━━━━━━━━━━━━━━━┛`;
       ...
       conn.sendButton(m.chat, submenu, son, vid1, 
        [['𝙈𝙀𝙉𝙐 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 🚀', `${prefix}menu1`], 
         ['𝗔𝗟𝗟 𝗠𝗘𝗡𝗨 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 𝗥𝗨𝗦𝗛𝗤𝗘𝗘𝗡𝗣𝗜𝗧𝗛𝗨 📜', `${prefix}allmenu`], 
         ['𝗠𝗘𝗡𝗨 𝗖𝗢𝗠𝗠𝗔𝗡𝗗 𝗥𝗨𝗦𝗛𝗤𝗘𝗘𝗡𝗣𝗜𝗧𝗛𝗨⚡', `${prefix}status`],
         ['𝗩𝗘𝗥𝗜𝗙𝗜𝗖𝗔𝗧𝗜𝗢𝗡 𝗤𝗘𝗘𝗡𝗣𝗜𝗧𝗛𝗨 ✅', `${prefix}reg ${pushname}.34`]], 
        null, null, m);
}
...
let listSections = []    
listSections.push({
title: '🗒️𝗥𝗨𝗦𝗛 𝗤𝗘𝗘𝗡 𝗣𝗜𝗧𝗛𝗨 🗒️',
rows: [{ header: "𝐌𝐄𝐍𝐔 𝐂𝐎𝐌𝐏𝐋𝐄𝐓𝗘", title: "", id: `.allmenu`, description: `Muestra el menu completo\n` }, 
{ header: "𝐌𝐄𝐍𝐔 𝐃𝐄𝐒𝐂𝗜𝗣𝗧𝗜𝗢𝗡", title: "", id: `.menu1`, description: `Muestra el menu de descargas\n`},
{ header: "𝐀𝐔𝐃𝐈𝐎𝐒", title: "", id: `.menu2`, description: `Muestra el menu de audios palabra clave para interactuar con el bot\n` },
{ header: "𝐌𝐄𝐍𝐔 𝐆𝐑𝗢𝗨𝗣𝗦", title: "", id: `.menu3`, description: `Muestra el menu de gestión del Grupo\n` },
{ header: "𝗥𝗨𝗦𝗛", title: "", id: `.menu4`, description: `Muestra el menu para buscar información\n` },
{ header: "𝗥𝗨𝗦𝗛𝗛", title: "", id: `.menu5`, description: `Muestra el menu de juegos para divertir tu grupo con multi juegos\n` }, 
{ header: "𝗥𝗨𝗦𝗛𝗛", title: "", id: `.menu6`, description: `Muestra el menu de efecto\n` }, 
{ header: "𝐂𝐎𝐍𝗩𝗘𝗥𝗧", title: "", id: `.menu7`, description: `Muestra el menu de convertidores\n` }, 
...
{ header: "𝐌𝐄𝐍𝐔  𝐏𝐑𝐎𝐏𝐈𝐄𝐓𝐀𝐑𝐈𝐎", title: "", id: `.menu11`, description: `Muestra el menu solo para propietario del bot\n` },
{ header: "𝐂𝗢𝗡𝗙𝗜𝗚𝗨𝗥𝗔𝗖𝗜𝗢𝗡", title: "", id: `.enable`, description: `configuraciones para mi grupo\n` },
{ header: "𝐌𝐄𝐍𝐔 +𝟏𝟖", title: "", id: `.menu18`, description: `Muestra el menu +18 (usarlo bajo tu responsabilidad)\n` }, 
{ header: "𝐋𝐎𝐆𝐎𝐒", title: "", id: `.logos`, description: `Muestra la lista para crear logos\n` }
]})

conn.sendList(m.chat, menu, botname, `𝗥𝗨𝗦𝗛 ✨`, listSections, {quoted: fkontak})
}
...
if (command === 'menu' || command === 'Menu') {
    ...
    conn.sendButton(m.chat, submenu, menu0, randomImage, 
        [['𝙈𝙀𝙉𝙐💥', `#help`], 
         ['𝙈𝙀𝙉𝙐 𝘾𝙊𝙈𝙋𝙇𝙀𝙏𝗘 📜', `#allmenu`], 
         ['𝗣𝗜𝗡𝗚⚡', `#ping`],
         ['𝘼𝙐𝙏𝙊 𝙑𝙀𝙍𝙄𝙁𝗜𝗖𝗔𝗧𝗜𝗢𝗡 ✅', `#reg ${pushname}.${nunber}`]], 
        null, null, m);
}*/
...
*╭─╮─᤻─᳒─᤻᳒᯽⃟ᰳᰬᰶ┈*⃐🔄 𝗗𝗢𝗪𝗡𝗟𝗢𝗔𝗗 𝗠𝗘𝗡𝗨*️⃟ᬽ፝֟━*
├➸${prefix}𝙥𝙡𝙖𝙮 _(𝙙𝙚𝙨𝙘𝙖𝙧𝙜𝙖𝙧 𝙢𝙪𝙨𝙞𝙘𝙖)_
...
*╭─╮─᤻─᳒─᤻᳒᯽⃟ᰳᰬᰶ┈*🔎⃐𝗦𝗘𝗔𝗥𝗖𝗛 𝗠𝗘𝗡𝗨*️⃟ᬽ፝֟━*
...
*╭─╮─᤻─᳒─᤻᳒᯽⃟ᰳᰬᰶ┈*🎤 𝗖𝗢𝗡𝗩𝗘𝗥𝗧 𝗠𝗘𝗡𝗨*️⃟ᬽ፝֟━*
├➸ *(Powerd by rush)*
├ *✧･ﾟ: *✧･ﾟ:*✧･ﾟ: *✧･ﾟ:*✧･ﾟ: *✧･ﾟ:
├➸${prefix}𝙗𝙖𝙨𝙨
├➸${prefix}𝙗𝙡𝙤𝙬𝙣
...
*╭─╮─᤻─᳒─᤻᳒᯽⃟ᰳᰬᰶ┈*⃐🧧𝘾𝙊𝙉𝙑𝙀𝙍𝙏 𝗠𝗘𝗡𝗨*️⃟ᬽ፝֟━*
├➸${prefix}𝙩𝙤𝙪𝙧𝙡
├➸${prefix}𝙩𝙩𝙨
├➸${prefix}𝙩𝙤𝙢𝙥3
├➸${prefix}𝙩𝙤𝙞𝙢𝙜
...
*╭─╮─᤻─᳒─᤻᳒᯽⃟ᰳᰬᰶ┈*⃐🪙 MENU*️⃟ᬽ፝֟━*
├➸${prefix}𝙢𝙞𝙣𝙖𝙧 _(POWERD BY RUSH)_
├➸${prefix}𝙧𝙤𝙗𝙖𝙧
...
*╭─╮─᤻─᳒─᤻᳒᯽⃟ᰳᰬᰶ┈*⃐👽STICKER MENU*️⃟ᬽ፝֟━*
├❥ *(𝗽𝗼𝘄𝗲𝗿𝗱 𝗯𝘆 𝗿𝘂𝘀𝗵*
├ *✧･ﾟ: *✧･ﾟ:*✧･ﾟ: *✧･ﾟ:*✧･ﾟ: *✧･ﾟ:
├➸${prefix}𝙨
├➸${prefix}𝙨𝙩𝙞𝙘𝙠𝙚𝙧 
...
conn.sendMessage(m.chat, { text: lenguaje.menu.text15(vs), contextInfo:{forwardedNewsletterMessageInfo: { newsletterJid: '1203632911111111@newsletter', serverMessageId: '', newsletterName: 'RUSH-BOT' }, mentions: [sender], forwardingScore: 9999999, isForwarded: true, "externalAdReply": {"showAdAttribution": true, "containsAutoReply": true, "title": ` ${wm}`, "body": ` ${vs}`, "previewType": "PHOTO", thumbnail: imagen1, sourceUrl: `${pickRandom([nna, nn, md, yt])}`}}}, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})}

if (command == 'reglas') {
conn.sendMessage(m.chat, { text: lenguaje.menu.text16, contextInfo:{forwardedNewsletterMessageInfo: { newsletterJid: '1203632911111111@newsletter', serverMessageId: '', newsletterName: 'RUSH-BOT' }, mentions: [sender], forwardingScore: 9999999, isForwarded: true, "externalAdReply": {"showAdAttribution": true, "containsAutoReply": true, "title": ` ${wm}`, "body": ` ${vs}`, "previewType": "PHOTO", thumbnail: imagen1, sourceUrl: `${pickRandom([nna, nn, md, yt])}`}}}, { quoted: fkontak, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100})}}
